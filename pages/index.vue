                ...
                <div v-for="(persona,i) in personas" :id='`personaEntry_${i}`' class="flex flex-col bg-white rounded-xl p-4">
                    ...
                    <div v-show="showNewGastoInput && currentPersonaId === persona.id" :class="`${persona.id}`" class="flex justify-between items-center px-5 py-2 border rounded-full border-indigo-200">
                        ...
                        <div class="flex justify-center items-center gap-2">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6 stroke-red-500" @click="limpiarEstados">
                    ...
                    <ul v-if="persona.gastos.length > 0" class='flex flex-col space-y-2 my-2'>
                        <li v-for="(gasto,i) in persona.gastos" >
                            ...
                            <div v-show="showEditGastoInput && currentGastoId === gasto.id" class="flex justify-between items-center px-5 py-2  border rounded-full border-indigo-200">
                                ...
                                <div class="flex justify-center items-center gap-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6 stroke-green-400" @click="confirmarEdicionGasto(persona, gasto)">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6 stroke-red-500" @click="limpiarEstados">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 9.75l4.5 4.5m0-4.5l-4.5 4.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            ...
                            <div class="flex justify-between items-center px-5 py-2 border rounded-full border-indigo-200">
                                ...
                                <div class="flex justify-center items-center gap-2">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-6 h-6 stroke-red-500" @click="eliminarGasto(persona,gasto)">
